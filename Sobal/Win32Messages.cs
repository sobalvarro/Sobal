...
namespace Sobal
{
    ...
    public static class WPARAM_WINDOWS_STATE
    {
        public static IntPtr Maximized { get; } = new IntPtr(2);



    }
    public static class DWMWA
    {
        public const int WINDOW_CORNER_PREFERENCE = 33;
    }

    public static class DWMWCP
    {
